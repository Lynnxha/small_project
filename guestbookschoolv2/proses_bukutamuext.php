...
$query = mysqli_query($koneksi, "INSERT INTO tbl_bukutamuext (tgl_kunjung, nama, no_identitas, email, no_hp, instansi, subjek) VALUES ('$tanggal', '$nama', '$noidentitas', '$email', '$nohp', '$instansi', '$tujuan')");
